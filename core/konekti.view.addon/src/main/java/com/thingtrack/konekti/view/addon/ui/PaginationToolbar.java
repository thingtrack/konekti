...
public class PaginationToolbar<T> extends AbstractToolbar {
	...
	ButtonGroup previousButtonGroup = new ButtonGroup();
	ButtonGroup lastButtonGroup = new ButtonGroup();
	...
	public static final String NO_PAGE_SIZE = "Todos";
	...
	public void setPageList(PageList<T> pageList){
		...
		if(pageList.getPageIndex() < pageList.getPages()-1){

 ...
 */
@Repository
public class EmployeeAgentStatusDaoImpl extends JpaDao<EmployeeAgentStatus, Integer> implements EmployeeAgentStatusDao {
	@Override
	public EmployeeAgentStatus getByName(String name) throws Exception {
		EmployeeAgentStatus employeeAgentStatus = (EmployeeAgentStatus)getEntityManager()

 ...
 */
@Repository
public class SupplierAgentDaoImpl extends JpaDao<SupplierAgent, Integer> implements SupplierAgentDao {
	@Override
	public SupplierAgent getByName(String name) throws Exception {
		SupplierAgent supplierAgent = (SupplierAgent)getEntityManager()

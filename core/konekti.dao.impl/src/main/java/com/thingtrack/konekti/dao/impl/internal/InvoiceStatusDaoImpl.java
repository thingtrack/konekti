 ...
 */
@Repository
public class InvoiceStatusDaoImpl extends JpaDao<InvoiceStatus, Integer> implements InvoiceStatusDao {
	@Override
	public InvoiceStatus getByCode(String code) throws Exception {
		InvoiceStatus invoiceStatus = (InvoiceStatus)getEntityManager()

 ...
 */
@Repository
public class OfferRequestDaoImpl extends JpaDao<OfferRequest, Integer> implements OfferRequestDao {
	@Override
	public OfferRequest getByCode(String code) throws Exception {
		OfferRequest offerRequest = (OfferRequest)getEntityManager()

 ...
 */
@Repository
public class ServiceStatusDaoImpl extends JpaDao<ServiceStatus, Integer> implements ServiceStatusDao {
	@Override
	public ServiceStatus getByCode(String code) throws Exception {
		// Retrieve existing code
		ServiceStatus serviceStatus = (ServiceStatus)getEntityManager()

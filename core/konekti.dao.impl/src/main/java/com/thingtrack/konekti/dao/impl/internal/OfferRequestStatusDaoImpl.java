 ...
 */
@Repository
public class OfferRequestStatusDaoImpl extends JpaDao<OfferRequestStatus, Integer> implements OfferRequestStatusDao {
	@Override
	public OfferRequestStatus getByCode(String code) throws Exception {
		OfferRequestStatus offerRequestStatus = (OfferRequestStatus)getEntityManager()

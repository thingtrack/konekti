 ...
 */
@Repository
public class FeedbackTypeDaoImpl extends JpaDao<FeedbackType, Integer> implements FeedbackTypeDao {
	@Override
	public FeedbackType getByCode(String code) throws Exception {
		FeedbackType feedbackType = (FeedbackType)getEntityManager()

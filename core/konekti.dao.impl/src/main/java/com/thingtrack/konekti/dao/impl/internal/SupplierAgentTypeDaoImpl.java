 ...
 */
@Repository
public class SupplierAgentTypeDaoImpl extends JpaDao<SupplierAgentType, Integer> implements SupplierAgentTypeDao {
	@Override
	public SupplierAgentType getByCode(String code) throws Exception {
		SupplierAgentType supplierAgentType = (SupplierAgentType)getEntityManager()

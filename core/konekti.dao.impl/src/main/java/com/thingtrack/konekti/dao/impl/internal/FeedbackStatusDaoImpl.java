 ...
 */
@Repository
public  class FeedbackStatusDaoImpl extends JpaDao<FeedbackStatus, Integer> implements FeedbackStatusDao {
	@Override
	public FeedbackStatus getByCode(String code) throws Exception {
		FeedbackStatus feedbackStatus = (FeedbackStatus)getEntityManager()

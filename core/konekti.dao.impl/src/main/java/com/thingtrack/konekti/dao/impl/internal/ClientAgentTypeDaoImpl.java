 ...
 */
@Repository
public class ClientAgentTypeDaoImpl extends JpaDao<ClientAgentType, Integer> implements ClientAgentTypeDao {
	@Override
	public ClientAgentType getByCode(String code) throws Exception {
		ClientAgentType clientAgentType = (ClientAgentType)getEntityManager()

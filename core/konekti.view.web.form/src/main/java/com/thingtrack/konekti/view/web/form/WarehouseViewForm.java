...
public class WarehouseViewForm extends CustomComponent {

	@AutoGenerated
	private AbsoluteLayout mainLayout;
	@AutoGenerated
	private ComboBox warehouseTypeField;
	@AutoGenerated
	...
	private BeanItemContainer<WarehouseType> bcWarehouseType = new BindingSource<WarehouseType>(WarehouseType.class);
	 ...
	 */
	public WarehouseViewForm() throws IllegalArgumentException, Exception {
		buildMainLayout();
	...
	private void getServices() {
		try {
			BundleContext bundleContext = FrameworkUtil.getBundle(WarehouseViewForm.class).getBundleContext();
			...
			ServiceReference warehouseServiceReference = bundleContext.getServiceReference(WarehouseTypeService.class.getName());
			warehouseTypeService = WarehouseTypeService.class.cast(bundleContext.getService(warehouseServiceReference));
	...
	private void loadData() throws IllegalArgumentException, Exception {
		...
		bcWarehouseType.removeAllItems();
		bcWarehouseType.addAll(warehouseTypeService.getAll());		
		
		locationField.setContainerDataSource(bcLocation);
		warehouseTypeField.setContainerDataSource(bcWarehouseType);
	}
	...
	private AbsoluteLayout buildMainLayout() {
		...
		// warehouseTypeField
		warehouseTypeField = new ComboBox();
		warehouseTypeField.setCaption("Tipo Almacén");
		warehouseTypeField.setImmediate(false);
		warehouseTypeField.setWidth("-1px");
		warehouseTypeField.setHeight("-1px");
		warehouseTypeField.setTabIndex(4);
		warehouseTypeField.setRequired(true);
		mainLayout.addComponent(warehouseTypeField, "top:100.0px;left:19.0px;");

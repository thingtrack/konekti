...
public class UserOrganizationCollectionField extends AbstractField {
	...
	protected void updateLabels() {
		userOrganizationTreeTable.setColumnHeaders(new String[] { getI18N().getMessage("com.thingtrack.konekti.view.web.form.field.UserOrganizationCollectionField.userOrganizationTreeTable.column.code"), 
				   getI18N().getMessage("com.thingtrack.konekti.view.web.form.field.UserOrganizationCollectionField.userOrganizationTreeTable.column.description"), 
				   getI18N().getMessage("com.thingtrack.konekti.view.web.form.field.UserOrganizationCollectionField.userOrganizationTreeTable.column.defecto")});

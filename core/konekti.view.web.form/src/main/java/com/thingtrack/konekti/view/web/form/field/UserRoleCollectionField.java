...
public class UserRoleCollectionField extends AbstractField {
	...
	private BeanItemContainer<Area> dsArea = new BeanItemContainer<Area>(Area.class);
	...
	private void setRoleHandler() {
		...
		btnCopyRole.addListener(new ClickListener() {			
			public void buttonClick(ClickEvent event) {
				...
				final Area editingArea = (Area) cmbArea.getValue();
				...
				try {
					...
					roleCopy = roleService.createNewEntity(editingArea);
				} catch (Exception e) {
					throw new RuntimeException(
							"¡No se pudo crear el nuevo rol!",
							e);
	...
	public void setValue(Object object) {
		...
		if(object instanceof User){
			...
			try {
				// fill all Area Roles and areas activer for the user
				...
				dsArea.removeAllItems();
				dsArea.addAll(context.getUser().getAreas());
				
				cmbArea.setContainerDataSource(dsArea);
				
				// set active Area in the active Area
				cmbArea.setValue(context.getUser().getActiveArea());
	...
	private void getServices() {
		try {
			...
			ServiceReference areaServiceReference = bundleContext.getServiceReference(Area.class.getName());

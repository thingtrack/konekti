...
public class SupplierSelectorWindow extends Window {
	...
	// selector datasource
	private BindingSource<Supplier> bsSupplier = new BindingSource<Supplier>(Supplier.class, 0);
	 ...
	 * visual editor.
	 */
	public SupplierSelectorWindow(IWorkbenchContext context, final Window parentWindow, Supplier entity, final CloseWindowDialogListener listener) {
		buildMainLayout();
	 ...
	 */
	 public void btnSelect_Click (Button.ClickEvent event) {
		domainEntity = bsSupplier.getItemId();

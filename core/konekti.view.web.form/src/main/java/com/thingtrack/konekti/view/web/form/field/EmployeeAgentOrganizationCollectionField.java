...
public class EmployeeAgentOrganizationCollectionField extends CustomField {
	...
	public EmployeeAgentOrganizationCollectionField() {
		...
		employeeAgentOrganizationTreeTable.addContainerProperty("Codigo", CheckBox.class, "");
		employeeAgentOrganizationTreeTable.addContainerProperty("Descripción", String.class, "");
	...
	public void setValue(Object object) {
		...
		if(object instanceof EmployeeAgent){
			...
			try {
				...
				// Expand the tree
				for (Object itemId: employeeAgentOrganizationTreeTable.getItemIds())
					employeeAgentOrganizationTreeTable.setCollapsed(itemId, false);
			} catch (Exception e) {
			...
			organizationCheck.addListener(new ValueChangeListener() {
				...
				public void valueChange(Property.ValueChangeEvent event) {
					if ((Boolean)organizationCheck.getValue())
						employeeAgent.getOrganizations().add((Organization)organizationCheck.getData());
					else
						employeeAgent.getOrganizations().remove((Organization)organizationCheck.getData());
			...
			organizationDefaultCheck.addListener(new ValueChangeListener() {
				...
				public void valueChange(Property.ValueChangeEvent event) {
					if ((Boolean)organizationDefaultCheck.getValue())
						if ((Boolean)organizationDefaultCheck.getValue()) {
							employeeAgent.setDefaultOrganization((Organization)organizationDefaultCheck.getData());
				...
				locationCheck.addListener(new ValueChangeListener() {
					...
					public void valueChange(Property.ValueChangeEvent event) {
						if ((Boolean)locationCheck.getValue())
							employeeAgent.getLocations().add((Location)locationCheck.getData());
						else
							employeeAgent.getLocations().remove((Location)locationCheck.getData());
				...
				locationDefaultCheck.addListener(new ValueChangeListener() {
					...
					public void valueChange(Property.ValueChangeEvent event) {						
						if ((Boolean)locationDefaultCheck.getValue()) {
							employeeAgent.setDefaultLocation((Location)locationDefaultCheck.getData());
					...
					areaCheck.addListener(new ValueChangeListener() {
						...
						public void valueChange(Property.ValueChangeEvent event) {
							if ((Boolean)areaCheck.getValue())
								employeeAgent.getAreas().add((Area)areaCheck.getData());
							else
								employeeAgent.getAreas().remove((Area)areaCheck.getData());
					...
					areaDefaultCheck.addListener(new ValueChangeListener() {
						...
						public void valueChange(Property.ValueChangeEvent event) {
							if ((Boolean)areaDefaultCheck.getValue()) {
								employeeAgent.setDefaultArea((Area)areaDefaultCheck.getData());
	...
	private boolean isDefaultOrganization(String code) {
		if (employeeAgent.getDefaultOrganization() != null && employeeAgent.getDefaultOrganization().getCode().equals(code))
			return true;
	...
	private boolean isDefaultLocation(String code) {
		if (employeeAgent.getDefaultLocation() != null && employeeAgent.getDefaultLocation().getCode().equals(code))
			return true;
	...
	private boolean isDefaultArea(String code) {
		if (employeeAgent.getDefaultArea() != null && employeeAgent.getDefaultArea().getCode().equals(code))
			return true;
	...
	private void unsetDefaultOrganization(String code) {
		for (Object itemId: employeeAgentOrganizationTreeTable.getItemIds()) {
			Item item = employeeAgentOrganizationTreeTable.getItem(itemId);

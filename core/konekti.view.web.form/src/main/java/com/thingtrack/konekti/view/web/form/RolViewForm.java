...
public class RolViewForm extends CustomComponent {

	@AutoGenerated
	private AbsoluteLayout mainLayout;
	@AutoGenerated
	private TabSheet permisionField;
	@AutoGenerated
	...
	private AbsoluteLayout buildMainLayout() {
		...
		// permisionField
		permisionField = new TabSheet();
		permisionField.setCaption("Usuarios/Permisos");
		permisionField.setImmediate(false);
		permisionField.setWidth("487px");
		permisionField.setHeight("137px");
		mainLayout.addComponent(permisionField, "top:283.0px;left:20.0px;");

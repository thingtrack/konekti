...
public class SupplierViewForm extends CustomComponent {
	...
	@AutoGenerated
	private SupplierOrganizationCollectionField supplierOrganizationCollectionField;
	@AutoGenerated
	...
	private void initComponents() {
		...
		supplierOrganizationCollectionField.setCaption("Organizaciones");
	...
	private VerticalLayout buildOrganizationLayout() {
		...
		// organizationsField
		supplierOrganizationCollectionField = new SupplierOrganizationCollectionField();
		supplierOrganizationCollectionField.setImmediate(false);
		supplierOrganizationCollectionField.setWidth("100.0%");
		supplierOrganizationCollectionField.setHeight("100.0%");
		organizationLayout.addComponent(supplierOrganizationCollectionField);
		organizationLayout.setExpandRatio(supplierOrganizationCollectionField, 1.0f);

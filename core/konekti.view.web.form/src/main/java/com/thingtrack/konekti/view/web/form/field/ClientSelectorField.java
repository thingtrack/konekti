...
public class ClientSelectorField extends AbstractField {
	@AutoGenerated
		...
		btnSearchEntity.addListener(new ClickListener() {			
			...
			public void buttonClick(ClickEvent event) {
				try {
					...
					ClientSelectorWindow windowDialog = new ClientSelectorWindow(context, getApplication().getMainWindow(), client, new ClientSelectorWindow.CloseWindowDialogListener() {
	...
	protected void updateLabels() {
		btnSearchEntity.setDescription(getI18N().getMessage("com.thingtrack.konekti.view.web.form.field.ClientSelectorField.btnSearchEntity.description"));
		btnClearEntity.setDescription(getI18N().getMessage("com.thingtrack.konekti.view.web.form.field.ClientSelectorField.btnClearEntity.description"));
		btnAddEntity.setDescription(getI18N().getMessage("com.thingtrack.konekti.view.web.form.field.ClientSelectorField.btnAddEntity.description"));

...
public class InvoiceLineViewForm extends CustomComponent {
	...
	private BeanItemContainer<Iva> bcIva = new BindingSource<Iva>(Iva.class);
	...
	private void getServices() {
		try {
			...
			ServiceReference ivaServiceReference = bundleContext.getServiceReference(IvaService.class.getName());
			ivaService = IvaService.class.cast(bundleContext.getService(ivaServiceReference));
		}
		catch (Exception e) {
			e.getMessage();

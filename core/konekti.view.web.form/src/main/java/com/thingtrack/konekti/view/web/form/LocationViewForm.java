...
public class LocationViewForm extends CustomComponent {
	...
	private AbsoluteLayout buildMainLayout() {
		...
		mainLayout.addComponent(locationTypeField, "top:60.0px;left:485.0px;");
		
		// cifField
		cifField = new TextField();
		cifField.setCaption("CIF");
		cifField.setImmediate(false);
		cifField.setWidth("124px");
		cifField.setHeight("-1px");
		mainLayout.addComponent(cifField, "top:60.0px;left:350.0px;");

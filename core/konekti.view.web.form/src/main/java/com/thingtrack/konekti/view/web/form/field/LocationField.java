...
import com.thingtrack.konekti.view.web.form.internal.CoordinatesInputComponent;
...
public class LocationField extends CustomField implements ValueChangeListener, ValueChangeNotifier{
	...
	@AutoGenerated
	private CoordinatesInputComponent coordinatesInputComponent;
	@AutoGenerated
	...
	public void valueChange(Property.ValueChangeEvent event) {
		 ...
		 else if(property instanceof CoordinatesInputComponent && addressInputComponent.getValue() != geocodedLocation){
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		verticalLayout_2.setWidth("250px");
		...
		addressInputComponent.setWidth("100.0%");
	...
	private VerticalLayout buildVerticalLayout_3() {
		...
		verticalLayout_3.setWidth("250px");
		verticalLayout_3.setHeight("-1px");
		verticalLayout_3.setMargin(false);
		
		// coordinatesInputComponent
		coordinatesInputComponent = new CoordinatesInputComponent();
		coordinatesInputComponent.setImmediate(false);
		coordinatesInputComponent.setWidth("100.0%");

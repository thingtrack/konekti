...
public class ClientViewForm extends CustomComponent {
	...
	private ClientOrganizationCollectionField clientOrganizationCollectionField;
	@AutoGenerated
	...
	private void initComponents() {
		...
		clientOrganizationCollectionField.setCaption("Organizaciones");
	...
	private VerticalLayout buildOrganizationLayout() {
		...
		// organizationsField
		clientOrganizationCollectionField = new ClientOrganizationCollectionField();
		clientOrganizationCollectionField.setImmediate(false);
		clientOrganizationCollectionField.setWidth("100.0%");
		clientOrganizationCollectionField.setHeight("100.0%");
		organizationLayout.addComponent(clientOrganizationCollectionField);
		organizationLayout.setExpandRatio(clientOrganizationCollectionField, 1.0f);

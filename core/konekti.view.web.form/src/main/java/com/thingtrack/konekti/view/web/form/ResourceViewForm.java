...
public class ResourceViewForm extends CustomComponent {

	@AutoGenerated
	private AbsoluteLayout mainLayout;
	@AutoGenerated
	private Table actionsField;
	@AutoGenerated
	...
	private AbsoluteLayout buildMainLayout() {
		...
		// actionsField
		actionsField = new Table();
		actionsField.setCaption("Acciones");
		actionsField.setImmediate(false);
		actionsField.setWidth("500px");
		actionsField.setHeight("139px");
		mainLayout.addComponent(actionsField, "top:281.0px;left:20.0px;");

...
public class ClientOrganizationCollectionField extends CustomField {
	...
	public ClientOrganizationCollectionField() {
		...
		organizationsBindingSource = new BindingSource<Organization>(
				Organization.class);

		organizationsTable.setContainerDataSource(organizationsBindingSource);
		organizationsTable.addGeneratedColumn(
				ClientAssignmentColumn.CLIENT_COLUMN_ID,
				new ClientAssignmentColumn());
		organizationsTable.setVisibleColumns(new String[] { "cif",
				"description", ClientAssignmentColumn.CLIENT_COLUMN_ID });
	...
	public void setPropertyDataSource(Property newDataSource) {
		...
		if (newDataSource.getValue() instanceof List) {
			...
			assignedOrganizations = new ArrayList<Organization>();
	...
	private class ClientAssignmentColumn implements Table.ColumnGenerator {
		...
		static final String CLIENT_COLUMN_ID = "client-assignment";
		...
		public Object generateCell(Table source, Object itemId, Object columnId) {
			...
			assignmentColumn.setValue(assignedOrganizations
					.contains(organizationItem));
			...
			assignmentColumn.addListener(new ValueChangeListener() {
				...
				public void valueChange(Property.ValueChangeEvent event) {
					...
					boolean assignmentValue = (Boolean) event.getProperty()
							.getValue();

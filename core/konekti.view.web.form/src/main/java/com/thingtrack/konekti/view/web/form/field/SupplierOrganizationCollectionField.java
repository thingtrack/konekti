...
public class SupplierOrganizationCollectionField extends CustomField {
	...
	@AutoGenerated
	private TreeTable supplierOrganizationTreeTable;
	...
	public SupplierOrganizationCollectionField() {
		...
		supplierOrganizationTreeTable.addContainerProperty("Name", CheckBox.class, "");
		supplierOrganizationTreeTable.addContainerProperty("Description", String.class, "");
		supplierOrganizationTreeTable.addContainerProperty("Defecto", CheckBox.class, "");
	...
	public void setValue(Object object) {
		...
		if(object instanceof Supplier){
			...
			try {
				...
				// Expand the tree
				for (Object itemId: supplierOrganizationTreeTable.getItemIds())
					supplierOrganizationTreeTable.setCollapsed(itemId, false);
			} catch (Exception e) {
	...
	public void setPropertyDataSource(Property newDataSource) {
		if(newDataSource.getValue() instanceof Supplier){
			...
			organizationCheck.addListener(new ValueChangeListener() {
				...
				public void valueChange(Property.ValueChangeEvent event) {
					if ((Boolean)organizationCheck.getValue())
						supplier.getOrganizations().add((Organization)organizationCheck.getData());
					else
						supplier.getOrganizations().remove((Organization)organizationCheck.getData());
			...
			organizationDefaultCheck.addListener(new ValueChangeListener() {
				...
				public void valueChange(Property.ValueChangeEvent event) {
					if ((Boolean)organizationDefaultCheck.getValue())
						if ((Boolean)organizationDefaultCheck.getValue()) {
							supplier.setDefaultOrganization((Organization)organizationDefaultCheck.getData());
							unsetDefaultOrganization(((Organization)organizationDefaultCheck.getData()).getCode());
						}
					
				}
			});			
			supplierOrganizationTreeTable.addItem(new Object[]{organizationCheck, organization.getName(), organizationDefaultCheck}, entityId);			
				...
				locationCheck.addListener(new ValueChangeListener() {
					...
					public void valueChange(Property.ValueChangeEvent event) {
						if ((Boolean)locationCheck.getValue())
							supplier.getLocations().add((Location)locationCheck.getData());
						else
							supplier.getLocations().remove((Location)locationCheck.getData());
				...
				locationDefaultCheck.addListener(new ValueChangeListener() {
					...
					public void valueChange(Property.ValueChangeEvent event) {						
						if ((Boolean)locationDefaultCheck.getValue()) {
							supplier.setDefaultLocation((Location)locationDefaultCheck.getData());
							unsetDefaultLocation(((Location)locationDefaultCheck.getData()).getCode());
						}						
						
					}
				});
				supplierOrganizationTreeTable.addItem(new Object[]{locationCheck, location.getName(), locationDefaultCheck}, entityId);
				locationId = entityId;
				
				supplierOrganizationTreeTable.setParent(locationId, organizationId);
					...
					areaCheck.addListener(new ValueChangeListener() {
						...
						public void valueChange(Property.ValueChangeEvent event) {
							if ((Boolean)areaCheck.getValue())
								supplier.getAreas().add((Area)areaCheck.getData());
							else
								supplier.getAreas().remove((Area)areaCheck.getData());
					...
					areaDefaultCheck.addListener(new ValueChangeListener() {
						...
						public void valueChange(Property.ValueChangeEvent event) {
							if ((Boolean)areaDefaultCheck.getValue()) {
								supplier.setDefaultArea((Area)areaDefaultCheck.getData());
								unsetDefaultArea(((Area)areaDefaultCheck.getData()).getCode());
							}
							
						}
					});
					supplierOrganizationTreeTable.addItem(new Object[]{areaCheck, area.getName(), areaDefaultCheck}, entityId);
					areaId = entityId;
					
					supplierOrganizationTreeTable.setParent(areaId, locationId);
	...
	private boolean containsOrganization(String code) {
		for (Organization organization : supplier.getOrganizations()) {
	...
	private boolean isDefaultOrganization(String code) {
		if (supplier.getDefaultOrganization() != null && supplier.getDefaultOrganization().getCode().equals(code))
			return true;
	...
	private boolean containsLocation(String code) {
		for (Location location : supplier.getLocations()) {
	...
	private boolean isDefaultLocation(String code) {
		if (supplier.getDefaultLocation() != null && supplier.getDefaultLocation().getCode().equals(code))
			return true;
	...
	private boolean containsArea(String code) {
		for (Area area : supplier.getAreas()) {
	...
	private boolean isDefaultArea(String code) {
		if (supplier.getDefaultArea() != null && supplier.getDefaultArea().getCode().equals(code))
			return true;
	...
	private void unsetDefaultOrganization(String code) {
		for (Object itemId: supplierOrganizationTreeTable.getItemIds()) {
			Item item = supplierOrganizationTreeTable.getItem(itemId);
	...
	private VerticalLayout buildMainLayout() {
		...
		supplierOrganizationTreeTable = new TreeTable();
		supplierOrganizationTreeTable.setImmediate(true);
		supplierOrganizationTreeTable.setWidth("100.0%");
		supplierOrganizationTreeTable.setHeight("100.0%");
		mainLayout.addComponent(supplierOrganizationTreeTable);
		mainLayout.setExpandRatio(supplierOrganizationTreeTable, 1.0f);

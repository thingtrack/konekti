...
public class UserField extends AbstractField {
	...
	@AutoGenerated
	private PopupDateField expirationDateField;
	@AutoGenerated
	...
	public UserField() {		
		...
		expirationDateField.addListener(new ValueChangeListener() {
			@Override
			public void valueChange(
					com.vaadin.data.Property.ValueChangeEvent event) {
				if (user != null && expirationDateField.getValue() != null)
					user.setExpirationDate((Date)expirationDateField.getValue());
				else
					user.setExpirationDate(null);
			}
		});
		
		commentField.addListener(new ValueChangeListener() {
			@Override
			public void valueChange(
					com.vaadin.data.Property.ValueChangeEvent event) {				
				if (user != null && commentField.getValue() != null)
					user.setComment(commentField.getValue().toString());
	...
	public void setPropertyDataSource(Property newDataSource) {
		...
		if (user != null) {
			...
			expirationDateField.setValue(user.getExpirationDate());
			commentField.setValue(user.getComment());
	...
	protected void updateLabels() {
		...
		expirationDateField.setCaption(getI18N().getMessage("com.thingtrack.konekti.view.web.form.field.UserField.expirationDateField.caption"));
	}

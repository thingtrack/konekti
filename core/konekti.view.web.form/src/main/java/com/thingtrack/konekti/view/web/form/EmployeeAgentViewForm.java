...
public class EmployeeAgentViewForm extends CustomComponent {
	...
	@AutoGenerated
	private UserRoleCollectionField roleTwinTableField;
	@AutoGenerated
	...
	private VerticalLayout buildRolLayout() {
		...
		// roleTwinTableField
		roleTwinTableField = new UserRoleCollectionField();
		roleTwinTableField.setImmediate(false);
		roleTwinTableField.setWidth("100.0%");
		roleTwinTableField.setHeight("100.0%");
		rolLayout.addComponent(roleTwinTableField);
		rolLayout.setExpandRatio(roleTwinTableField, 1.0f);

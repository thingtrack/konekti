...
public class EmployeeAgentViewForm extends CustomComponent {
    ...
    public void attach() {
		...
		if (getParent().getWindow() instanceof WindowDialog<?>) {
			...
			userOrganizationCollectionField.setValue(employeeAgent);			
		}
	}
	...
	private VerticalLayout buildOrganizationLayout() {
		...
		// employeeAgentOrganizationCollectionField
		...
		organizationLayout
				.addComponent(userOrganizationCollectionField);
		organizationLayout.setExpandRatio(
				userOrganizationCollectionField, 1.0f);

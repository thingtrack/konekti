...
public class StockStatus implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((stockStatusId == null) ? 0 : stockStatusId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (stockStatusId == null) {
			if (other.stockStatusId != null)
				return false;
		} else if (!stockStatusId.equals(other.stockStatusId))
			return false;
		return true;
	}
	...
	public String toString() {
		return "StockStatus [stockStatusId=" + stockStatusId + ", code=" + code

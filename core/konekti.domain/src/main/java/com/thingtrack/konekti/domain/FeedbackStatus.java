 ...
 * Entity class
 * <p>
 * Represents the feedback statuses
 * <p>
...
public class FeedbackStatus implements Serializable {
	...
	/**
	 * @param feedbackStatusId the feedbackStatusId to set
	 */
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((feedbackStatusId == null) ? 0 : feedbackStatusId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (feedbackStatusId == null) {
			if (other.feedbackStatusId != null)
				return false;
		} else if (!feedbackStatusId.equals(other.feedbackStatusId))
			return false;
		return true;
	}
	...
	public String toString() {
		return "FeedbackStatus [feedbackStatusId=" + feedbackStatusId

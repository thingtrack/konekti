...
public class TireStatus implements Serializable {
	...
	/**
	 * @param tireStatusId the tireStatusId to set
	 */
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((tireStatusId == null) ? 0 : tireStatusId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (code == null) {
			...
			return false;
		if (tireStatusId == null) {
			if (other.tireStatusId != null)
				return false;
		} else if (!tireStatusId.equals(other.tireStatusId))
			return false;
		return true;
	}
	...
	public String toString() {
		return "TireStatus [tireStatusId=" + tireStatusId + ", code=" + code

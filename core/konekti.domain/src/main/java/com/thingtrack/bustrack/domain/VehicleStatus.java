...
public class VehicleStatus implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((vehicleStatusId == null) ? 0 : vehicleStatusId.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (vehicleStatusId == null) {
			if (other.vehicleStatusId != null)
				return false;
		} else if (!vehicleStatusId.equals(other.vehicleStatusId))
			return false;
		return true;
	}
	...
	public String toString() {
		return "VehicleStatus [vehicleStatusId=" + vehicleStatusId + ", code="

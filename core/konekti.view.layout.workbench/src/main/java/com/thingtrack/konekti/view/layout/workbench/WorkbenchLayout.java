...
public class WorkbenchLayout extends CustomComponent implements IWorkbenchLayout {
	...
	public void removeModules(LOCATION location) {
		if (location == LOCATION.TOP)
			getTopPanelWorkbench().removeModules(location);
		else if (location == LOCATION.LEFT)
			getLeftPanelWorkbench().removeModules(location);
		else if(location == LOCATION.CENTER)
			getCentralPanelWorkbench().removeModules(location);
		else if(location == LOCATION.RIGHT)
			getRightPanelWorkbench().removeModules(location);
		else if(location == LOCATION.BOTTON)
			getBottonPanelWorkbench().removeModules(location);

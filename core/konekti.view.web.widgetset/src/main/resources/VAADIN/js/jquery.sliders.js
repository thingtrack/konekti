  ...
  $.fn.sliders = function() {
    ...
    return this.each(function() {
      ...
      function getSlider() {
        ...
        return $('div.slider', container).css({ display: 'block', position: 'absolute', left: 0, top: 0, height: h });
      }
      
      function getSlides() {
          //return slider ? slider.children().children().children().children().get() : container.children().children().children().children().get();
    	  //return slider ? slider.find('div.v-table,div.v-tabsheet') : container.find('div.v-table,div.v-tabsheet');
    	  return slider ? slider.find('div.v-tabsheet') : container.find('div.v-tabsheet');
      ...
      function align() {
        ...
        switch(options.transition) {
          case 'slide':
            slider.css({ width: w * slides.length, left: -w * index });           

...
public class MenuLayout extends CustomComponent implements IMenuLayout {
	...
	public void setUsernameLogoutMenuItem(String username){
		
		//FIXME: User Name
//		MenuBar.MenuItem logout = mbLogon.addItem(username, null, null);
//		logout.addItem("Logout", null, new Command() {
//			
//			@Override
...
//		});
	...
	public MenuLayout() {
		...
		applicationLogoEmbedded.setSource(new ThemeResource("images/logoKonektiFleet.png"));
		...
		//FIXME: Remove Help MenuItem
		//menuBarLayout.setImmediate(true);
		// Another top-level item
		ThemeResource	 question = new ThemeResource("images/question.png");
//		MenuBar.MenuItem help = mbLogon.addItem("", question, null);
//		help.setStyleName("help");
//				
//		help.addItem("Ayuda Online", null, mycommand);
		...
		profilePopupButton.addComponent(new LogoutViewForm());
		helpPopupButton.addComponent(new AboutViewForm());
	}
	...
	private HorizontalLayout buildMainLayout() {
		...
		applicationLogoEmbedded.setWidth("-1px");
		applicationLogoEmbedded.setHeight("-1px");
		applicationLogoEmbedded.setSource(new ThemeResource(
		...
		mainLayout.setComponentAlignment(applicationLogoEmbedded,
				new Alignment(33));

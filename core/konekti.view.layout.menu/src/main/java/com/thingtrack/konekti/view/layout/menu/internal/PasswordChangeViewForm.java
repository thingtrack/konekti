...
public class PasswordChangeViewForm extends AbstractViewForm {
	...
	protected void updateLabels() {
		currentPasswordField.setCaption(getI18N().getMessage("com.thingtrack.konekti.view.layout.menu.internal.PasswordChangeViewForm.currentPasswordField.caption"));
		newPasswordField.setCaption(getI18N().getMessage("com.thingtrack.konekti.view.layout.menu.internal.PasswordChangeViewForm.newPasswordField.caption"));
		confirmPasswordField.setCaption(getI18N().getMessage("com.thingtrack.konekti.view.layout.menu.internal.PasswordChangeViewForm.confirmPasswordField.caption"));
		applyPasswordChangebutton.setCaption(getI18N().getMessage("com.thingtrack.konekti.view.layout.menu.internal.PasswordChangeViewForm.applyPasswordChangebutton.caption"));
		applyPasswordChangebutton.setDescription(getI18N().getMessage("com.thingtrack.konekti.view.layout.menu.internal.PasswordChangeViewForm.applyPasswordChangebutton.description"));
		cancelPasswordChangebutton.setCaption(getI18N().getMessage("com.thingtrack.konekti.view.layout.menu.internal.PasswordChangeViewForm.cancelPasswordChangebutton.caption"));
		cancelPasswordChangebutton.setDescription(getI18N().getMessage("com.thingtrack.konekti.view.layout.menu.internal.PasswordChangeViewForm.cancelPasswordChangebutton.description"));

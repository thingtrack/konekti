...
public class AddressViewContainer extends AbstractViewContainer {
	 ...
	 * visual editor.
	 */
	public AddressViewContainer(IWorkbenchContext context, IModule module) {
		buildMainLayout();
	...
	private void createViews() {
		...
		addressView = new AddressView(context, this);
		sliderView.addView(addressView);
		views.put(0, addressView);
	}

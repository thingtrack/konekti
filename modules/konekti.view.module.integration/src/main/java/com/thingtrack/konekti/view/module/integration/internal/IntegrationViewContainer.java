...
public class IntegrationViewContainer extends AbstractViewContainer {
	 ...
	 * visual editor.
	 */
	public IntegrationViewContainer(IWorkbenchContext context, IModule module) {
		buildMainLayout();
	...
	private void createViews() {
		...
		integrationView = new IntegrationView(context, this);
		sliderView.addView(integrationView);
		views.put(0, integrationView);

...
public class FeedbackView extends AbstractView implements
	...
	private void initView() {
		...
		try {
			bsFeedback.addNestedContainerProperty("invoice.code");
			bsFeedback.addNestedContainerProperty("invoice.client.description");
			
			dgFeedback.setBindingSource(bsFeedback);

			dgFeedback.setVisibleColumns(new String[] { "comment", "invoice.code", "invoice.client.description", "feedbackType.description", "feedbackStatus.description", "feedbackDate" });
			dgFeedback.setColumnHeaders(new String[] { "Comentarios", "Código Factura", "Cliente Factura", "Tipo", "Estado", "Fecha Registro" });
		} catch (Exception ex) {
			ex.getMessage();

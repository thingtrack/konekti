...
public class FeedbackViewContainer extends AbstractViewContainer {
	...
	private static ThreadLocal<FeedbackService> threadFeedbackService = new ThreadLocal<FeedbackService>();
	 ...
	 * visual editor.
	 */
	public FeedbackViewContainer(IWorkbenchContext context, IModule module) {
		buildMainLayout();
	...
	private void createViews() {
		...
		threadFeedbackService.set(feedbackService);
		
		// add all views controlled by SliderView Component
		feedbackView = new FeedbackView(this);
		sliderView.addView(feedbackView);
		views.put(0, feedbackView);
	}
	...
	private void destroyViews() {
		...
		threadFeedbackService.set(null);
		
	}
	
    public static FeedbackService getFeedbackService() {
        return threadFeedbackService.get();

...
public class KonektiObrResource {
	private String id;
	...
	public KonektiObrResource() {	
	}
	
	public KonektiObrResource(String id, String symbolicName, String version,
			String presentationName, Repository repository, URL url,
			...
			String copyright, String sourceUrl, Long size, String[] keys, Resource resource) {
		super();
		this.id = id;
